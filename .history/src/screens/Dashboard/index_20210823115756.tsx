...
//file-contract
import {
  Container, DashboardVerticalDivider, DetailsButton, Header
} from './styles';
  ...
  return (
    <Container>
      ...
      <View style={styles.servicesView}>
        <Text style={styles.labelText}>Serviços - Acesso rápido</Text>
        <View
          style={{
            display: 'flex',
            flexDirection: 'row',
          ...
          <Text style={styles.servicesText}>Solicitar religação</Text>
        ...
        <View
          ...
          <TouchableOpacity
            onPress={() => navigation.navigate('ContractEmail')}>
        ...
        <View
          ...
          <Text style={styles.servicesText}>Fazer reclamação</Text>
